...
inputEl.addEventListener("input", (0, _lodashDefault.default).debounce(inputSearch, 500));
function inputSearch(event) {
    ...
    fetch(`${API_URL}/name/${query}`).then((response)=>response.json()).then((data)=>{
        if (Array.isArray(data)) {
            if (data.length > 10) (0, _core.alert)({
                text: 'Too many matches found. Please enter a more specific query!'
            });
            else if (data.length >= 2 && data.length <= 10) renderCountries(data);
            else if (data.length === 1) renderCountry(data);
        } else boxEl.innerHTML = '<p class="error-msg">\u041A\u0440\u0430\u0457\u043D\u0443 \u043D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u043E</p>';
    }).catch((error)=>{
...
},{"lodash":"LUhzz","@pnotify/core":"fay4s","@pnotify/mobile":"5RXYV","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"LUhzz":[function(require,module,exports,__globalThis) {
/**
 * @license
...
(function() {
    ...
    /** Used as the semantic version number. */ var VERSION = '4.17.23';
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirecb6e", {})

//# sourceMappingURL=http_first.31b563d9.js.map
